...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Collector.status'
        db.delete_column('cbmonitor_collector', 'status')

        # Adding field 'Collector.enabled'
        db.add_column('cbmonitor_collector', 'enabled',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

    def backwards(self, orm):
        # Adding field 'Collector.status'
        db.add_column('cbmonitor_collector', 'status',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'Collector.enabled'
        db.delete_column('cbmonitor_collector', 'enabled')
