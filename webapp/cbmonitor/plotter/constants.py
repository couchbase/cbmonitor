LABELS = {
    ...
    "memory_size": "Memory used by plasma",
    "num_cached_pages": "Number of pages cached pages by plasma",
    "num_pages": "Total number of pages by plasma",
    "num_pages_swapout": "Number of pages swapped out by plasma",
    "num_pages_swapin": "Number of pages swapped in by plasma",
    "bytes_incoming": "Incoming bytes to plasma",
    "bytes_written": "Number of bytes written by plasma",
    "write_amp": "Write amplification of plasma",
    "lss_fragmentation": "lss fragmentation by plasma",
    "cache_hits": "Number of cache hits for plasma",
    "cache_misses": "Number of cache miss for plasma",
    "cache_hit_ratio": "Cache hit ratio",
    "resident_ratio": "Indexer resident ratio for plasma, calculated by pages",
    "allocated": "Memory allocated for plasma",
    "freed": "Memory feed by plasma",
    "reclaimed": "Memory reclaimed by plasma",
