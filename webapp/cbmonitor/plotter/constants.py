LABELS = {
    ...
    "MainStore_resident_ratio": "Indexer resident ratio for plasma, calculated by pages",
    ...
    "BackStore_resident_ratio": "Indexer resident ratio for plasma, calculated by pages",
