LABELS = {
    ...
    "FSReadBytes": "Number of bytes",
    "FSWriteBytes": "Number of bytes",
    ...
    "num_rows_scanned_aggr": "Number of scanned by 2i aggregated",
    ...
    "MemFree": "The amount of physical memory not used by the system, bytes",
    "MemAvailable": "Estimated memory available for starting new applications, bytes",
    ...
    "syncgateway__global__resource_utilization__node_cpu_percent_utilization": "node_cpu_percent_utilization",
    ...
    "syncgateway__per_db__db__cache__skipped_sequence_skip_list_nodes": "skipped_sequence_skip_list_nodes",
    "syncgateway__per_db__db__cache__current_skipped_seq_count": "current_skipped_seq_count",
    ...
    "syncgateway__per_db__db__database__num_doc_writes_rejected": "num_doc_writes_rejected",
    ...
    "sgw_resource_utilization_node_cpu_percent_utilization": "node_cpu_percent_utilization",
    ...
    "fluentbit_output_proc_records_total": "Total successfully sent log records",
    "fluentbit_output_proc_bytes_total": "Total successfully sent bytes",
    "fluentbit_output_dropped_records_total": "Total dropped log records",
    "fluentbit_output_retried_records_total": "Total retried records",
    "fluentbit_output_retries_failed_total": "Total failed retries",
    "fluentbit_output_errors_total": "Total failed chunk",
    "fluentbit_input_records_total": "Total ingested records",
    "fluentbit_input_bytes_total": "Total ingested bytes",
    ...
    "contbk_backed_up_part_time_bucket": "Time between backed up parts",
    ...
    "cm_app_telemetry_curr_connections": "Number of active app telemetry websocket connections",
    "kv_current_external_client_connections_python": "Number of active Python client connections",
    "kv_current_external_client_connections_java": "Number of active Java client connections",
    "sdk_kv_r_total": "Total SDK KV requests operations",
    "sdk_kv_r_timedout": "Total SDK timedout KV requests operations",
    "sdk_kv_r_cancelled": "Total SDK cancelled KV requests operations",
    "sdk_query_r_total": "Total SDK Query requests operations",
    "sdk_query_r_timedout": "Total SDK timedout Query requests operations",
    "sdk_query_r_cancelled": "Total SDK cancelled Query requests operations",
    "sdk_search_r_total": "Total SDK Search requests operations",
    "sdk_search_r_timedout": "Total SDK timedout Search requests operations",
    "sdk_search_r_cancelled": "Total SDK cancelled Search requests operations",
    "sdk_analytics_r_total": "Total SDK Analytics requests operations",
    "sdk_analytics_r_timedout": "Total SDK timedout Analytics requests operations",
    "sdk_analytics_r_cancelled": "Total SDK cancelled Analytics requests operations",
    "sdk_management_r_total": "Total SDK Management requests operations",
    "sdk_management_r_timedout": "Total SDK timedout Management requests operations",
    "sdk_management_r_cancelled": "Total SDK cancelled Management requests operations",
    ...
    # Fusion kvstore stats
    "NumLogStoreCachedReads": "Number of cached reads from the log store",
    "NumReads": "Number of reads",
    "NumSyncs": "Number of syncs",
    "NumBytesSynced": "Number of bytes synced",
    "NumBytesIncoming": "Number of incoming bytes",
    "NumLogCleanBytesRead": "Number of bytes read during log cleaning",
    "NumLogCleanReads": "Number of reads during log cleaning",
    "ExtentMergerBytesRead": "Number of bytes read by the extent merger",
    "ExtentMergerReads": "Number of reads by the extent merger",
    "NumLogMergerBytesRead": "Number of bytes read by the log merger",
    "NumLogsMerged": "Number of logs merged",
    "NumLogStoreRemotePuts": "Number of remote puts to the log store",
    "NumLogStoreRemoteGets": "Number of remote gets from the log store",
    "NumLogStoreRemoteLists": "Number of remote lists from the log store",
    "NumLogStoreRemoteDeletes": "Number of remote deletes from the log store",
    "NumBytesMigrated": "Number of bytes migrated",
    "NumLogStoreCachedReadsPerSec": "Number of cached reads from the log store per second",
    "NumReadsPerSec": "Number of reads per second",
    "NumSyncsPerSec": "Number of syncs per second",
    "NumBytesSyncedPerSec": "Number of bytes synced per second",
    "NumBytesIncomingPerSec": "Number of incoming bytes per second",
    "NumLogCleanBytesReadPerSec": "Number of bytes read during log cleaning per second",
    "NumLogCleanReadsPerSec": "Number of reads during log cleaning per second",
    "ExtentMergerBytesReadPerSec": "Number of bytes read by the extent merger per second",
    "ExtentMergerReadsPerSec": "Number of reads by the extent merger per second",
    "NumLogMergerBytesReadPerSec": "Number of bytes read by the log merger per second",
    "NumLogsMergedPerSec": "Number of logs merged per second",
    "NumLogStoreRemotePutsPerSec": "Number of remote puts to the log store per second",
    "NumLogStoreRemoteGetsPerSec": "Number of remote gets from the log store per second",
    "NumLogStoreRemoteListsPerSec": "Number of remote lists from the log store per second",
    "NumLogStoreRemoteDeletesPerSec": "Number of remote deletes from the log store per second",
    "NumBytesMigratedPerSec": "Number of bytes migrated per second",
    "LogStoreDataSize": "Data size of the log store",
    "NumLogSegments": "Number of log segments",
    "NumFiles": "Number of files",
    "NumFileExtents": "Number of file extents",
    "LogStoreGarbageSize": "Garbage size of the log store",
    "LogStoreSummarySectionSize": "Summary section size of the log store",
